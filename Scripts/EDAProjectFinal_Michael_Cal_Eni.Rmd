...
# get NC counties shapefile for reference map
counties_NC <- 
  st_read('../Data/Spatial/cb_2018_us_county_20m.shp') %>% 
  filter(STATEFP == 37)

# get Macon County shapefile for reference map
Macon_county = 
  counties_NC %>% 
  filter(NAME == 'Macon')
...
NC.plot = 
  ...
  geom_sf(data = counties_NC,
          ...
          color = 'black',
          alpha = 1) +
  geom_sf(data = Macon_county, 
          fill = 'lightsalmon',
          color = 'black',
          alpha = 1) +
  # geom_sf(data = coweeta.sf,
  #         shape = 21, 
  #         color = "lightsalmon3", 
  #         fill = 'lightsalmon', 
  #         size = .5, 
  ...
  annotate(geom = 'text',
           ...
           size = 3,
           color = "#545454",
           label = expression(paste("Macon County"))) +
  labs(title = "North Carolina",
       x=' ',
       y=' ') +
  scale_y_continuous(breaks = c(34, 35, 36)) +
  scale_x_continuous(breaks = c(-76, -78, -80, -82, -84))

# map of plot locations in Macom County
Macon.plot =
  ggplot() +
  geom_sf(data = Macon_county, 
          fill = NA,
  ...
  geom_sf(data = coweeta.sf,
          ...
          size = 2, 
          alpha = 0.6) +
  labs(title = "Macon County") +
  scale_x_continuous(breaks = c(-83.2, -83.4, -83.6)) +
  scale_y_continuous(breaks = c(35, 35.1, 35.2, 35.3))
  # theme(axis.text.x = element_text(angle = 45,
  #                                  vjust = 1,
  #                                  hjust = 1))

# map of just plot locations
Coweeta.plot =
  ggplot() +
  geom_sf(data = coweeta.sf,
          shape = 21, 
  ...
  scale_x_continuous(breaks = c(-83.42, -83.44, -83.46, -83.48)) +
  scale_y_continuous(breaks = c(35.03, 35.04, 35.05, 35.06))
  # theme(axis.text.x = element_text(angle = 45,
  #                                  vjust = 1,
  #                                  hjust = 1))

# a cowplot of all of them
plots_grid_spatial <-
  plot_grid(NC.plot,
            Macon.plot,
            Coweeta.plot,
